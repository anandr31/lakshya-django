...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConferenceApplicationFeedback.time_stamp'
        db.add_column('research_conferenceapplicationfeedback', 'time_stamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConferenceApplicationFeedback.time_stamp'
        db.delete_column('research_conferenceapplicationfeedback', 'time_stamp')
