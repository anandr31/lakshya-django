...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('research_panelist', (
        ...
        db.send_create_signal('research', ['Panelist'])

        # Adding field 'ConferenceApplication.conference_url'
        db.add_column('research_conferenceapplication', 'conference_url',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConferenceApplication.research_paper'
        db.add_column('research_conferenceapplication', 'research_paper',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('research_panelist')

        # Deleting field 'ConferenceApplication.conference_url'
        db.delete_column('research_conferenceapplication', 'conference_url')

        # Deleting field 'ConferenceApplication.research_paper'
        db.delete_column('research_conferenceapplication', 'research_paper')
