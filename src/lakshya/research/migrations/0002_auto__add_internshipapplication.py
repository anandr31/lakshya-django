...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InternshipApplication'
        db.create_table('research_internshipapplication', (
            ...
            ('internship_place', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('internship_division', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('supervisor_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('internship_dates', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('internship_city', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('internship_country', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        db.send_create_signal('research', ['InternshipApplication'])


    def backwards(self, orm):
        # Deleting model 'InternshipApplication'
        db.delete_table('research_internshipapplication')
