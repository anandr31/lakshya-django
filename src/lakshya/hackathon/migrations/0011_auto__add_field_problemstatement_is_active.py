...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProblemStatement.is_active'
        db.add_column(u'hackathon_problemstatement', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProblemStatement.is_active'
        db.delete_column(u'hackathon_problemstatement', 'is_active')
