...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hackathon.version'
        db.alter_column(u'hackathon_hackathon', 'version', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Hackathon.version'
        db.alter_column(u'hackathon_hackathon', 'version', self.gf('django.db.models.fields.IntegerField')())
