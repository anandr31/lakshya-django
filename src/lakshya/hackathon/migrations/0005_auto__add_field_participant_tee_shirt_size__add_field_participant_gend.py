...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.tee_shirt_size'
        db.add_column(u'hackathon_participant', 'tee_shirt_size',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)

        # Adding field 'Participant.gender'
        db.add_column(u'hackathon_participant', 'gender',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.tee_shirt_size'
        db.delete_column(u'hackathon_participant', 'tee_shirt_size')

        # Deleting field 'Participant.gender'
        db.delete_column(u'hackathon_participant', 'gender')
