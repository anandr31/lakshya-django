...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('people_teammember', 'photo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
        # Adding field 'Person.profile_pic'
        db.add_column('people_person', 'profile_pic',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TeamMember.photo'
        db.alter_column('people_teammember', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
        # Deleting field 'Person.profile_pic'
        db.delete_column('people_person', 'profile_pic')
