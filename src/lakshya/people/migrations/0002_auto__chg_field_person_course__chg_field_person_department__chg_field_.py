...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.course'
        db.alter_column('people_person', 'course', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Person.department'
        db.alter_column('people_person', 'department', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Person.year_of_passing'
        db.alter_column('people_person', 'year_of_passing', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Person.course'
        db.alter_column('people_person', 'course', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Person.department'
        db.alter_column('people_person', 'department', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Person.year_of_passing'
        db.alter_column('people_person', 'year_of_passing', self.gf('django.db.models.fields.IntegerField')(default=2012))
