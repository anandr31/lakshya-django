...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Team'
        db.delete_table('people_team')

        # Adding model 'TeamMember'
        db.create_table('people_teammember', (
        ...
        db.send_create_signal('people', ['TeamMember'])


    def backwards(self, orm):
        # Adding model 'Team'
        db.create_table('people_team', (
            ('linkedin_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('blog_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal('people', ['Team'])

        # Deleting model 'TeamMember'
        db.delete_table('people_teammember')
