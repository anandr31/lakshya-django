...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectUpdate.mail_status'
        db.add_column(u'crowdfunding_projectupdate', 'mail_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectUpdate.mail_status'
        db.delete_column(u'crowdfunding_projectupdate', 'mail_status')
    ...
    models = {
        ...
        u'crowdfunding.project': {
            ...
            'summary': ('django.db.models.fields.CharField', [], {'max_length': '160'}),
