...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'crowdfunding_project', 'team', self.gf('tinymce.models.HTMLField')(max_length=1000))
        ...
        # Changing field 'ProjectUpdate.update'
        db.alter_column(u'crowdfunding_projectupdate', 'update', self.gf('tinymce.models.HTMLField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Project.team'
        db.alter_column(u'crowdfunding_project', 'team', self.gf('django.db.models.fields.TextField')(max_length=1000))

        # Changing field 'Project.risks_and_challenges'
        db.alter_column(u'crowdfunding_project', 'risks_and_challenges', self.gf('django.db.models.fields.TextField')(max_length=4000))

        # Changing field 'Project.description'
        db.alter_column(u'crowdfunding_project', 'description', self.gf('django.db.models.fields.TextField')(max_length=1000))

        # Changing field 'ProjectUpdate.update'
        db.alter_column(u'crowdfunding_projectupdate', 'update', self.gf('django.db.models.fields.TextField')(max_length=300))
    ...
    models = {
        ...
        u'crowdfunding.project': {
            ...
            'risks_and_challenges': ('tinymce.models.HTMLField', [], {'max_length': '4000', 'blank': 'True'}),
