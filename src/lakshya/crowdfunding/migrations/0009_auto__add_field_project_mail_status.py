...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.mail_status'
        db.add_column(u'crowdfunding_project', 'mail_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.mail_status'
        db.delete_column(u'crowdfunding_project', 'mail_status')
