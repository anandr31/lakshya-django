...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'crowdfunding_project', 'description', self.gf('tinymce.models.HTMLField')(max_length=20000))
        ...
        db.alter_column(u'crowdfunding_project', 'summary', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Project.team'
        db.alter_column(u'crowdfunding_project', 'team', self.gf('tinymce.models.HTMLField')(max_length=10000))
    ...
    models = {
        ...
        u'crowdfunding.project': {
            ...
            'video_url': ('django.db.models.fields.URLField', [], {'max_length': '1000'})
        },
