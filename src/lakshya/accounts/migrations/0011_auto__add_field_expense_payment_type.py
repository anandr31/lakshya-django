...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expense.payment_type'
        db.add_column('accounts_expense', 'payment_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Expense.payment_type'
        db.delete_column('accounts_expense', 'payment_type')
