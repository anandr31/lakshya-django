...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentTemp.pan_card'
        db.add_column('accounts_paymenttemp', 'pan_card',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentTemp.pan_card'
        db.delete_column('accounts_paymenttemp', 'pan_card')
