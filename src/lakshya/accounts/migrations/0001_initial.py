...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_expense', (
            ...
            ('date_of_expense', self.gf('django.db.models.fields.DateField')()),
            ('date_of_entry', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('expense_header_first_level', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('expense_header_second_level', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('scan_bill', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('details', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('accounts', ['Expense'])

        # Adding model 'DonationFund'
        db.create_table('accounts_donationfund', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('accounts', ['DonationFund'])

        # Adding model 'Donation'
        db.create_table('accounts_donation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('date_of_donation', self.gf('django.db.models.fields.DateField')()),
            ('donor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'])),
        ...
        db.send_create_signal('accounts', ['Donation'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DonationFund'
        db.delete_table('accounts_donationfund')

        # Deleting model 'Donation'
        db.delete_table('accounts_donation')
