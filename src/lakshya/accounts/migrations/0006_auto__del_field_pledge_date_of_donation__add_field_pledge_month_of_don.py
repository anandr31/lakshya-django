...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Pledge.date_of_donation'
        db.delete_column('accounts_pledge', 'date_of_donation')

        # Adding field 'Pledge.month_of_donation'
        db.add_column('accounts_pledge', 'month_of_donation',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length='4'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Pledge.date_of_donation'
        db.add_column('accounts_pledge', 'date_of_donation',
                      self.gf('django.db.models.fields.DateField')(default='feb'),
                      keep_default=False)

        # Deleting field 'Pledge.month_of_donation'
        db.delete_column('accounts_pledge', 'month_of_donation')
