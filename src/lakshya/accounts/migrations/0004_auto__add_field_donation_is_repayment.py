...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.is_repayment'
        db.add_column('accounts_donation', 'is_repayment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donation.is_repayment'
        db.delete_column('accounts_donation', 'is_repayment')
