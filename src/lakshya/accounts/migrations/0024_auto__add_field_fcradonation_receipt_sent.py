...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FCRADonation.receipt_sent'
        db.add_column(u'accounts_fcradonation', 'receipt_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FCRADonation.receipt_sent'
        db.delete_column(u'accounts_fcradonation', 'receipt_sent')
