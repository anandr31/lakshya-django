...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Milestone.raised_amount'
        db.delete_column(u'accounts_milestone', 'raised_amount_id')


    def backwards(self, orm):
        # Adding field 'Milestone.raised_amount'
        db.add_column(u'accounts_milestone', 'raised_amount',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Donation'], null=True, blank=True),
                      keep_default=False)
