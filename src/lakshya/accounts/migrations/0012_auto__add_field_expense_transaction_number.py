...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expense.transaction_number'
        db.add_column('accounts_expense', 'transaction_number',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Expense.transaction_number'
        db.delete_column('accounts_expense', 'transaction_number')
