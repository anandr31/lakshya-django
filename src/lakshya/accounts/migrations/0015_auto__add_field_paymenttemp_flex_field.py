...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentTemp.flex_field'
        db.add_column('accounts_paymenttemp', 'flex_field',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentTemp.flex_field'
        db.delete_column('accounts_paymenttemp', 'flex_field')
    ...
    models = {
        ...
        'accounts.paymenttemp': {
            ...
            'flex_field': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
