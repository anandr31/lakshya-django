...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.bank_details'
        db.add_column('accounts_donation', 'bank_details',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Donation.transaction_details'
        db.alter_column('accounts_donation', 'transaction_details', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):
        # Deleting field 'Donation.bank_details'
        db.delete_column('accounts_donation', 'bank_details')


        # Changing field 'Donation.transaction_details'
        db.alter_column('accounts_donation', 'transaction_details', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
    ...
    models = {
        ...
        'accounts.paymenttemp': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pan_card': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'})
        },
        'accounts.pledge': {
