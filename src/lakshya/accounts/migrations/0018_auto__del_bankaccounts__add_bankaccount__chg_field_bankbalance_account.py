...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'BankAccounts'
        db.delete_table(u'accounts_bankaccounts')

        # Adding model 'BankAccount'
        db.create_table(u'accounts_bankaccount', (
            ...
            ('account_number', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('contact_email', self.gf('django.db.models.fields.EmailField')(max_length=50)),
            ('contact_phone', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'accounts', ['BankAccount'])


        # Changing field 'BankBalance.account'
        db.alter_column(u'accounts_bankbalance', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.BankAccount']))

    def backwards(self, orm):
        # Adding model 'BankAccounts'
        db.create_table(u'accounts_bankaccounts', (
            ('account_type', self.gf('django.db.models.fields.CharField')(max_length='10')),
            ('account_number', self.gf('django.db.models.fields.IntegerField')()),
            ('branch', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('contact_email', self.gf('django.db.models.fields.EmailField')(max_length=50)),
        ...
        db.send_create_signal(u'accounts', ['BankAccounts'])

        # Deleting model 'BankAccount'
        db.delete_table(u'accounts_bankaccount')


        # Changing field 'BankBalance.account'
        db.alter_column(u'accounts_bankbalance', 'account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.BankAccounts']))

    models = {
        u'accounts.bankaccount': {
            'Meta': {'object_name': 'BankAccount'},
            'account_number': ('django.db.models.fields.IntegerField', [], {}),
