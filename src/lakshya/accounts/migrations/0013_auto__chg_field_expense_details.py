...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Expense.details'
        db.alter_column('accounts_expense', 'details', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Expense.details'
        db.alter_column('accounts_expense', 'details', self.gf('django.db.models.fields.TextField')(default=''))
