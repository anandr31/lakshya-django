...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_milestone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('target_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=0)),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
            ('committed_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=0, blank=True)),
            ('raised_amount', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Donation'], null=True, blank=True)),
        ))
        db.send_create_signal(u'accounts', ['Milestone'])


    def backwards(self, orm):
        # Deleting model 'Milestone'
        db.delete_table(u'accounts_milestone')
    ...
    models = {
        ...
        u'accounts.milestone': {
            ...
            'committed_amount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '0', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'raised_amount': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.Donation']", 'null': 'True', 'blank': 'True'}),
