...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BankBalance.date'
        db.alter_column(u'accounts_bankbalance', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'BankBalance.date'
        db.alter_column(u'accounts_bankbalance', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
