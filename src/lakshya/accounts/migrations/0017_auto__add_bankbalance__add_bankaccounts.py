...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BankBalance'
        db.create_table(u'accounts_bankbalance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.BankAccounts'])),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('balance', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal(u'accounts', ['BankBalance'])
    ...
    def backwards(self, orm):
        # Deleting model 'BankBalance'
        db.delete_table(u'accounts_bankbalance')
    ...
    models = {
        u'accounts.bankaccounts': {
            'Meta': {'object_name': 'BankAccounts'},
        ...
        u'accounts.bankbalance': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.BankAccounts']"}),
