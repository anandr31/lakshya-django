...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentTemp.pledge_id'
        db.add_column(u'accounts_paymenttemp', 'pledge_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentTemp.pledge_id'
        db.delete_column(u'accounts_paymenttemp', 'pledge_id')
