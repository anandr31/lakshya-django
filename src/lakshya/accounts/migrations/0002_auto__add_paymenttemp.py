...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PaymentTemp'
        db.create_table('accounts_paymenttemp', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email_address', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('email_receipt', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('accounts', ['PaymentTemp'])


    def backwards(self, orm):
        # Deleting model 'PaymentTemp'
        db.delete_table('accounts_paymenttemp')
