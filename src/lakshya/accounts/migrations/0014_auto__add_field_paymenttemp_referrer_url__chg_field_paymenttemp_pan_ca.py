...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentTemp.referrer_url'
        db.add_column('accounts_paymenttemp', 'referrer_url',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'PaymentTemp.pan_card'
        db.alter_column('accounts_paymenttemp', 'pan_card', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):
        # Deleting field 'PaymentTemp.referrer_url'
        db.delete_column('accounts_paymenttemp', 'referrer_url')


        # Changing field 'PaymentTemp.pan_card'
        db.alter_column('accounts_paymenttemp', 'pan_card', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
