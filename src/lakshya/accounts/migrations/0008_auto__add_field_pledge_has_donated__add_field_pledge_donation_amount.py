...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pledge.has_donated'
        db.add_column('accounts_pledge', 'has_donated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Pledge.donation_amount'
        db.add_column('accounts_pledge', 'donation_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pledge.has_donated'
        db.delete_column('accounts_pledge', 'has_donated')

        # Deleting field 'Pledge.donation_amount'
        db.delete_column('accounts_pledge', 'donation_amount')
