...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.donation_type'
        db.add_column('accounts_donation', 'donation_type',
    ...
    def backwards(self, orm):
        # Deleting field 'Donation.donation_type'
        db.delete_column('accounts_donation', 'donation_type')
