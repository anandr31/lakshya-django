...
urlpatterns = patterns('',
    ...
    url(r'^audits$', TemplateView.as_view(template_name="audtis.html")),
    ...
    url(r'^payment-failure$', TemplateView.as_view(template_name="payment_failure.htnl")),
    #url(r'^payment-success$', direct_to_template, {'template' : 'payment_success.html'}, name='payment-success'),
    url(r'^payment-failure$', TemplateView.as_view(template_name="payment_success.html"), name="payment-success"),
)
