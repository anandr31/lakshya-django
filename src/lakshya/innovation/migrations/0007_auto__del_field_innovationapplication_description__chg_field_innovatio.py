...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'InnovationApplication', fields ['team_member']
        db.delete_unique('innovation_innovationapplication', ['team_member_id'])

        # Deleting field 'InnovationApplication.description'
        db.delete_column('innovation_innovationapplication', 'description')


        # Changing field 'InnovationApplication.team_member'
        db.alter_column('innovation_innovationapplication', 'team_member_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'], null=True))

    def backwards(self, orm):
        # Adding field 'InnovationApplication.description'
        db.add_column('innovation_innovationapplication', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'InnovationApplication.team_member'
        db.alter_column('innovation_innovationapplication', 'team_member_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['people.Person'], unique=True, null=True))
        # Adding unique constraint on 'InnovationApplication', fields ['team_member']
        db.create_unique('innovation_innovationapplication', ['team_member_id'])
    ...
    models = {
        ...
        'innovation.innovationapplication': {
            ...
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'team_member': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Person']", 'null': 'True', 'blank': 'True'}),
