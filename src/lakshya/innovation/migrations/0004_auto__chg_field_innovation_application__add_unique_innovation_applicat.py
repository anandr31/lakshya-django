...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Innovation.application'
        db.alter_column('innovation_innovation', 'application_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['innovation.InnovationApplication'], unique=True))
        # Adding unique constraint on 'Innovation', fields ['application']
        db.create_unique('innovation_innovation', ['application_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Innovation', fields ['application']
        db.delete_unique('innovation_innovation', ['application_id'])


        # Changing field 'Innovation.application'
        db.alter_column('innovation_innovation', 'application_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['innovation.InnovationApplication']))
