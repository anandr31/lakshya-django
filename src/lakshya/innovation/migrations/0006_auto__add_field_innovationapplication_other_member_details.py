...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InnovationApplication.other_member_details'
        db.add_column('innovation_innovationapplication', 'other_member_details',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InnovationApplication.other_member_details'
        db.delete_column('innovation_innovationapplication', 'other_member_details')
