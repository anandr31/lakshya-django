...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InnovationApplication.abstract'
        db.alter_column('innovation_innovationapplication', 'abstract', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'InnovationApplication.reviewer'
        db.alter_column('innovation_innovationapplication', 'reviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['people.Person']))

        # Changing field 'InnovationUpdate.date_of_update'
        db.alter_column('innovation_innovationupdate', 'date_of_update', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'InnovationApplication.abstract'
        db.alter_column('innovation_innovationapplication', 'abstract', self.gf('django.db.models.fields.files.FileField')(default=0, max_length=100))

        # Changing field 'InnovationApplication.reviewer'
        db.alter_column('innovation_innovationapplication', 'reviewer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['people.Person']))

        # Changing field 'InnovationUpdate.date_of_update'
        db.alter_column('innovation_innovationupdate', 'date_of_update', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))
    ...
    models = {
        ...
        'innovation.innovationapplication': {
            ...
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'team_members': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['people.Person']", 'null': 'True', 'blank': 'True'}),
