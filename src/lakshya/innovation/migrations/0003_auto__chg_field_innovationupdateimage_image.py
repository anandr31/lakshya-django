...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InnovationUpdateImage.image'
        db.alter_column('innovation_innovationupdateimage', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'InnovationUpdateImage.image'
        db.alter_column('innovation_innovationupdateimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
