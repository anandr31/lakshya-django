...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyAttribute.value'
        db.alter_column('entrepreneurship_companyattribute', 'value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'CompanyAttribute.value'
        db.alter_column('entrepreneurship_companyattribute', 'value', self.gf('django.db.models.fields.CharField')(default=0, max_length=255))
