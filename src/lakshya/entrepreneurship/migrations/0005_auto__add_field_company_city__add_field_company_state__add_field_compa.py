...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('entrepreneurship_company', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Company.state'
        db.add_column('entrepreneurship_company', 'state',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Company.postal_code'
        db.add_column('entrepreneurship_company', 'postal_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Company.country'
        db.add_column('entrepreneurship_company', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Company.contact_number'
        db.add_column('entrepreneurship_company', 'contact_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Company.contact_email'
        db.add_column('entrepreneurship_company', 'contact_email',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('entrepreneurship_company', 'city')

        # Deleting field 'Company.state'
        db.delete_column('entrepreneurship_company', 'state')

        # Deleting field 'Company.postal_code'
        db.delete_column('entrepreneurship_company', 'postal_code')

        # Deleting field 'Company.country'
        db.delete_column('entrepreneurship_company', 'country')

        # Deleting field 'Company.contact_number'
        db.delete_column('entrepreneurship_company', 'contact_number')

        # Deleting field 'Company.contact_email'
        db.delete_column('entrepreneurship_company', 'contact_email')
