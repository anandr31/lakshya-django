...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sector'
        db.create_table('entrepreneurship_sector', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal('entrepreneurship', ['Sector'])

        # Adding model 'Company'
        db.create_table('entrepreneurship_company', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=100)),
            ...
            ('video_url', self.gf('django.db.models.fields.URLField')(max_length=100, null=True, blank=True)),
            ('logo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('entrepreneurship', ['Company'])

        # Adding M2M table for field sectors on 'Company'
        db.create_table('entrepreneurship_company_sectors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('company', models.ForeignKey(orm['entrepreneurship.company'], null=False)),
            ('sector', models.ForeignKey(orm['entrepreneurship.sector'], null=False))
        ))
        db.create_unique('entrepreneurship_company_sectors', ['company_id', 'sector_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('entrepreneurship_sector')

        # Deleting model 'Company'
        db.delete_table('entrepreneurship_company')

        # Removing M2M table for field sectors on 'Company'
        db.delete_table('entrepreneurship_company_sectors')
    ...
    models = {
        ...
        'entrepreneurship.company': {
            ...
            'founders': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['people.Person']", 'through': "orm['entrepreneurship.FounderDetails']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'sectors': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['entrepreneurship.Sector']", 'symmetrical': 'False'}),
        ...
        'entrepreneurship.founderdetails': {
            'Meta': {'object_name': 'FounderDetails'},
