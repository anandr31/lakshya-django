...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.key_components'
        db.add_column(u'innovationgarage_project', 'key_components',
                      self.gf('tinymce.models.HTMLField')(default='', max_length=1000),
                      keep_default=False)


        # Changing field 'Project.description'
        db.alter_column(u'innovationgarage_project', 'description', self.gf('tinymce.models.HTMLField')(max_length=4000))

        # Changing field 'Project.team'
        db.alter_column(u'innovationgarage_project', 'team', self.gf('tinymce.models.HTMLField')(max_length=1000))

    def backwards(self, orm):
        # Deleting field 'Project.key_components'
        db.delete_column(u'innovationgarage_project', 'key_components')


        # Changing field 'Project.description'
        db.alter_column(u'innovationgarage_project', 'description', self.gf('django.db.models.fields.TextField')(max_length=4000))

        # Changing field 'Project.team'
        db.alter_column(u'innovationgarage_project', 'team', self.gf('django.db.models.fields.TextField')(max_length=1000))
