...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Event'
        db.create_table(u'innovationgarage_event', (
        ...
        db.send_create_signal(u'innovationgarage', ['Event'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'innovationgarage_event')
