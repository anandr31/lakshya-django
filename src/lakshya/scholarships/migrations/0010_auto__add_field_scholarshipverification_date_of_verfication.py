...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScholarshipVerification.date_of_verfication'
        db.add_column('scholarships_scholarshipverification', 'date_of_verfication',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScholarshipVerification.date_of_verfication'
        db.delete_column('scholarships_scholarshipverification', 'date_of_verfication')
