...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScholarshipVerification.house_ownership_type'
        db.alter_column('scholarships_scholarshipverification', 'house_ownership_type', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ScholarshipVerification.date_of_verfication'
        db.alter_column('scholarships_scholarshipverification', 'date_of_verfication', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'ScholarshipVerification.additional_comment'
        db.alter_column('scholarships_scholarshipverification', 'additional_comment', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ScholarshipVerification.vehicles_owned'
        db.alter_column('scholarships_scholarshipverification', 'vehicles_owned', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'ScholarshipVerification.mother_details'
        db.alter_column('scholarships_scholarshipverification', 'mother_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ScholarshipVerification.sibling_details'
        db.alter_column('scholarships_scholarshipverification', 'sibling_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ScholarshipVerification.aware_repayment_model'
        db.alter_column('scholarships_scholarshipverification', 'aware_repayment_model', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ScholarshipVerification.father_details'
        db.alter_column('scholarships_scholarshipverification', 'father_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ScholarshipVerification.question1'
        db.alter_column('scholarships_scholarshipverification', 'question1', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ScholarshipVerification.question2'
        db.alter_column('scholarships_scholarshipverification', 'question2', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ScholarshipVerification.house_type'
        db.alter_column('scholarships_scholarshipverification', 'house_type', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ScholarshipVerification.aware_renewal_criteria'
        db.alter_column('scholarships_scholarshipverification', 'aware_renewal_criteria', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ScholarshipVerification.final_recommendation'
        db.alter_column('scholarships_scholarshipverification', 'final_recommendation', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ScholarshipVerification.house_ownership_type'
        db.alter_column('scholarships_scholarshipverification', 'house_ownership_type', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ScholarshipVerification.date_of_verfication'
        db.alter_column('scholarships_scholarshipverification', 'date_of_verfication', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2012, 6, 19, 0, 0)))

        # Changing field 'ScholarshipVerification.additional_comment'
        db.alter_column('scholarships_scholarshipverification', 'additional_comment', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ScholarshipVerification.vehicles_owned'
        db.alter_column('scholarships_scholarshipverification', 'vehicles_owned', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'ScholarshipVerification.mother_details'
        db.alter_column('scholarships_scholarshipverification', 'mother_details', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ScholarshipVerification.sibling_details'
        db.alter_column('scholarships_scholarshipverification', 'sibling_details', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ScholarshipVerification.aware_repayment_model'
        db.alter_column('scholarships_scholarshipverification', 'aware_repayment_model', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ScholarshipVerification.father_details'
        db.alter_column('scholarships_scholarshipverification', 'father_details', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ScholarshipVerification.question1'
        db.alter_column('scholarships_scholarshipverification', 'question1', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ScholarshipVerification.question2'
        db.alter_column('scholarships_scholarshipverification', 'question2', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'ScholarshipVerification.house_type'
        db.alter_column('scholarships_scholarshipverification', 'house_type', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ScholarshipVerification.aware_renewal_criteria'
        db.alter_column('scholarships_scholarshipverification', 'aware_renewal_criteria', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ScholarshipVerification.final_recommendation'
        db.alter_column('scholarships_scholarshipverification', 'final_recommendation', self.gf('django.db.models.fields.IntegerField')(default=0))
