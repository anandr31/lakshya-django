...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('scholarships_scholarshipapplication', 'date_of_submission', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
        # Deleting field 'Scholar.scholar'
        db.delete_column('scholarships_scholar', 'scholar_id')
    ...
    def backwards(self, orm):
        ...
        db.delete_column('scholarships_scholar', 'person_id')
