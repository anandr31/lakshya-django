...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScholarshipScheme.status'
        db.add_column('scholarships_scholarshipscheme', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'ScholarshipScheme.curator'
        db.add_column('scholarships_scholarshipscheme', 'curator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ScholarshipScheme.last_updated'
        db.add_column('scholarships_scholarshipscheme', 'last_updated',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2012, 12, 23, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScholarshipScheme.status'
        db.delete_column('scholarships_scholarshipscheme', 'status')

        # Deleting field 'ScholarshipScheme.curator'
        db.delete_column('scholarships_scholarshipscheme', 'curator_id')

        # Deleting field 'ScholarshipScheme.last_updated'
        db.delete_column('scholarships_scholarshipscheme', 'last_updated')
