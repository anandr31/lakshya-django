...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FamilyDetail.occupation_annualincome'
        db.delete_column('scholarships_familydetail', 'occupation_annualincome')

        # Adding field 'FamilyDetail.occupation'
        db.add_column('scholarships_familydetail', 'occupation',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FamilyDetail.annualincome'
        db.add_column('scholarships_familydetail', 'annualincome',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FamilyDetail.occupation_annualincome'
        db.add_column('scholarships_familydetail', 'occupation_annualincome',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'FamilyDetail.occupation'
        db.delete_column('scholarships_familydetail', 'occupation')

        # Deleting field 'FamilyDetail.annualincome'
        db.delete_column('scholarships_familydetail', 'annualincome')
