...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scholar.donation_fund'
        db.alter_column('scholarships_scholar', 'donation_fund_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.DonationFund'], null=True))

    def backwards(self, orm):

        # Changing field 'Scholar.donation_fund'
        db.alter_column('scholarships_scholar', 'donation_fund_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['accounts.DonationFund']))
