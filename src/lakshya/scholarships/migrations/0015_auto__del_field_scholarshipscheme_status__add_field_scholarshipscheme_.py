...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScholarshipScheme.publish_status'
        db.add_column('scholarships_scholarshipscheme', 'publish_status',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ScholarshipScheme.publish_status'
        db.delete_column('scholarships_scholarshipscheme', 'publish_status')
