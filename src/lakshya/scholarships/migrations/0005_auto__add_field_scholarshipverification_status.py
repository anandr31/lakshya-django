...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScholarshipVerification.status'
        db.add_column('scholarships_scholarshipverification', 'status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScholarshipVerification.status'
        db.delete_column('scholarships_scholarshipverification', 'status')
