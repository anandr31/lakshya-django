...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ScholarshipScheme.min_scholarship_amount'
        db.delete_column('scholarships_scholarshipscheme', 'min_scholarship_amount')

        # Deleting field 'ScholarshipScheme.max_scholarship_amount'
        db.delete_column('scholarships_scholarshipscheme', 'max_scholarship_amount')

        # Adding field 'ScholarshipScheme.scholarship_amount'
        db.add_column('scholarships_scholarshipscheme', 'scholarship_amount',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ScholarshipScheme.min_scholarship_amount'
        db.add_column('scholarships_scholarshipscheme', 'min_scholarship_amount',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ScholarshipScheme.max_scholarship_amount'
        db.add_column('scholarships_scholarshipscheme', 'max_scholarship_amount',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ScholarshipScheme.scholarship_amount'
        db.delete_column('scholarships_scholarshipscheme', 'scholarship_amount')
    ...
    models = {
        ...
        'scholarships.scholarshipscheme': {
            ...
            'scholarship_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
