...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScholarshipScheme.website'
        db.alter_column('scholarships_scholarshipscheme', 'website', self.gf('django.db.models.fields.CharField')(max_length=350, null=True))

        # Changing field 'ScholarshipScheme.scholarship_amount'
        db.alter_column('scholarships_scholarshipscheme', 'scholarship_amount', self.gf('django.db.models.fields.CharField')(max_length=350, null=True))

        # Changing field 'ScholarshipScheme.how_to_apply'
        db.alter_column('scholarships_scholarshipscheme', 'how_to_apply', self.gf('django.db.models.fields.CharField')(max_length=350, null=True))

        # Changing field 'ScholarshipScheme.eligibility_criteria'
        db.alter_column('scholarships_scholarshipscheme', 'eligibility_criteria', self.gf('django.db.models.fields.CharField')(max_length=350, null=True))

    def backwards(self, orm):

        # Changing field 'ScholarshipScheme.website'
        db.alter_column('scholarships_scholarshipscheme', 'website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'ScholarshipScheme.scholarship_amount'
        db.alter_column('scholarships_scholarshipscheme', 'scholarship_amount', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ScholarshipScheme.how_to_apply'
        db.alter_column('scholarships_scholarshipscheme', 'how_to_apply', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'ScholarshipScheme.eligibility_criteria'
        db.alter_column('scholarships_scholarshipscheme', 'eligibility_criteria', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        'scholarships.familydetail': {
            ...
            'annualincome': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'scholarships.scholar': {
            ...
            'donation_fund': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.DonationFund']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'scholarships.scholarshipapplication': {
            ...
            'year_of_submission': ('django.db.models.fields.IntegerField', [], {'default': '2013', 'null': 'True', 'blank': 'True'})
        },
        ...
        'scholarships.scholarshipscheme': {
            'Meta': {'object_name': 'ScholarshipScheme'},
            'contact_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'contact_mobile': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'curator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'eligibility_criteria': ('django.db.models.fields.CharField', [], {'max_length': '350', 'null': 'True', 'blank': 'True'}),
            'funding_agency': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'how_to_apply': ('django.db.models.fields.CharField', [], {'max_length': '350', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'publish_status': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'repayment_type': ('django.db.models.fields.IntegerField', [], {}),
            'scholarship_amount': ('django.db.models.fields.CharField', [], {'max_length': '350', 'null': 'True', 'blank': 'True'}),
            'website': ('django.db.models.fields.CharField', [], {'max_length': '350', 'null': 'True', 'blank': 'True'})
        },
        'scholarships.scholarshipverification': {
            ...
            'date_of_verfication': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
