...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ScholarshipScheme'
        db.create_table('scholarships_scholarshipscheme', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('funding_agency', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('logo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('repayment_type', self.gf('django.db.models.fields.IntegerField')()),
            ('min_scholarship_amount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('max_scholarship_amount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('eligibility_criteria', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('how_to_apply', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('contact_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('contact_mobile', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
        ))
        db.send_create_signal('scholarships', ['ScholarshipScheme'])


    def backwards(self, orm):
        # Deleting model 'ScholarshipScheme'
        db.delete_table('scholarships_scholarshipscheme')
    ...
    models = {
        ...
        'scholarships.scholarshipscheme': {
            ...
            'eligibility_criteria': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'funding_agency': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'how_to_apply': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'max_scholarship_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'min_scholarship_amount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
