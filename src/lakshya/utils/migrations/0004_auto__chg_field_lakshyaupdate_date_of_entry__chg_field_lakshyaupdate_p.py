...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LakshyaUpdate.date_of_entry'
        db.alter_column('utils_lakshyaupdate', 'date_of_entry', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'LakshyaUpdate.photo'
        db.alter_column('utils_lakshyaupdate', 'photo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'LakshyaUpdate.date_of_entry'
        db.alter_column('utils_lakshyaupdate', 'date_of_entry', self.gf('django.db.models.fields.DateField')(auto_now=True, null=True))

        # Changing field 'LakshyaUpdate.photo'
        db.alter_column('utils_lakshyaupdate', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
