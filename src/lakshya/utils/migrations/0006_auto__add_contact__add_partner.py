...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'utils_contact', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('company', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('email_or_phone', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('project', self.gf('django.db.models.fields.SmallIntegerField')(default=4)),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'utils', ['Contact'])

        # Adding model 'Partner'
        db.create_table(u'utils_partner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'utils', ['Partner'])


    def backwards(self, orm):
        # Deleting model 'Contact'
        db.delete_table(u'utils_contact')

        # Deleting model 'Partner'
        db.delete_table(u'utils_partner')
